...
<head>
  ...
  <link rel="stylesheet" href="/MaBagnoleV1/public/assets/css/admin/users.css">
...
<body
  ...
  <aside class="w-72 bg-white dark:bg-surface border-r border-gray-200 dark:border-gray-800 hidden md:flex flex-col z-20 shadow-xl shadow-gray-200/50 dark:shadow-none">
    ...
    <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
      ...
      <a href="usersAdmin" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-primary/10 text-primary font-semibold transition-all">
      ...
      <div class="max-w-7xl mx-auto space-y-8">
        ...
        <div class="bg-white dark:bg-surface rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
          <div class="overflow-x-auto">
            <table id="users" class="w-full text-left border-collapse">
              <thead>
                  ...
                  ?>
                    <tr class="group hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                      ...
                      <td class="p-5 text-right flex items-center justify-end gap-1">
                        ...
                        <?php if ($client->getStatus() == '1'): ?>
                          <form action="block_user" method="POST" class="inline-block" onsubmit="return confirm('Voulez-vous vraiment bloquer ce client ?');">
                        ...
                        <?php else: ?>
                          <form action="activate_user" method="POST" class="inline-block" onsubmit="return confirm('Voulez-vous réactiver ce client ?');">
  ...
  <script src="/MaBagnoleV1/public/assets/js/admin/users.js"></script>
</body>
