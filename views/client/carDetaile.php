...
<body class="bg-gray-50 dark:bg-dark text-slate-800 dark:text-gray-200 font-sans antialiased selection:bg-primary selection:text-white">
    ...
    <nav class="sticky top-0 z-50 bg-white/80 dark:bg-surface/80 glass-panel border-b border-gray-100 dark:border-gray-800/50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20 items-center">
                <a href="index.html" class="flex items-center gap-3 group">
                    <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-indigo-700 text-white flex items-center justify-center shadow-glow group-hover:scale-110 transition-transform">
                        <span class="material-symbols-rounded text-[24px]">directions_car</span>
                    </div>
                    <span class="font-bold text-xl tracking-tight text-slate-900 dark:text-white">MaBagnole</span>
                </a>

                <div class="flex items-center gap-4">
                    <button onclick="toggleTheme()" class="p-2 rounded-full bg-gray-100 dark:bg-card text-slate-600 dark:text-yellow-400 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
                    ...
                    <div class="flex items-center gap-3">
                        <span class="text-sm font-semibold hidden sm:block">Ahmed Bennani</span>
                        <img src="https://i.pravatar.cc/150?u=a042581f4e29026704d" class="w-10 h-10 rounded-full border-2 border-white dark:border-card shadow-sm" alt="Profile">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white dark:bg-card rounded-3xl p-8 shadow-sm border border-gray-100 dark:border-gray-800/60">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div class="flex flex-col items-center p-5 bg-gray-50 dark:bg-surface rounded-2xl text-center border border-transparent hover:border-primary/20 transition-colors">
                            ...
                            <span class="font-bold text-slate-900 dark:text-white"><?= $voiture->getCarburantV() ?></span>
                        </div>
                        <div class="flex flex-col items-center p-5 bg-gray-50 dark:bg-surface rounded-2xl text-center border border-transparent hover:border-primary/20 transition-colors">
                            <div class="w-10 h-10 rounded-full bg-primary/10 text-primary flex items-center justify-center mb-3">
                            ...
                            <span class="font-bold text-slate-900 dark:text-white"><?= $voiture->getBoiteV() ?></span>
                        </div>
                        <div class="flex flex-col items-center p-5 bg-gray-50 dark:bg-surface rounded-2xl text-center border border-transparent hover:border-primary/20 transition-colors">
                            <div class="w-10 h-10 rounded-full bg-primary/10 text-primary flex items-center justify-center mb-3">
                            ...
                            <span class="font-bold text-slate-900 dark:text-white"><?= $voiture->getCategoryName() ?></span>
                        </div>
                        <div class="flex flex-col items-center p-5 bg-gray-50 dark:bg-surface rounded-2xl text-center border border-transparent hover:border-primary/20 transition-colors">
                            <div class="w-10 h-10 rounded-full bg-primary/10 text-primary flex items-center justify-center mb-3">
            ...
            <div class="lg:col-span-1">
                <div class="sticky top-28 bg-white dark:bg-card rounded-[2rem] p-6 shadow-2xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700/50">
                    ...
                    <form id="bookingForm" action="index.php" method="post" class="space-y-5">
                        <input type="hidden" id="basePrice" value="<?= $voiture->getPrixJourV() ?>">
                        <input type="hidden" value="paimentReservation" name="action">
