                ...
                <div class="bg-white dark:bg-card rounded-[2rem] p-6 shadow-sm border border-gray-100 dark:border-gray-800">
                    ...
                    <div class="space-y-2">
                        ...
                        <?php foreach ($themes as $theme): ?>
                            <a href="index.php?action=theme&idtheme=<?= $theme->getIdTheme() ?>" class="flex items-center justify-between p-3 rounded-xl hover:bg-gray-50 dark:hover:bg-surface border border-transparent hover:border-gray-200 dark:hover:border-gray-700 text-slate-600 dark:text-slate-300 transition-all group">
