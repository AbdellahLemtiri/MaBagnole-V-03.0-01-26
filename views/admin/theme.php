...
<head>
    ...
    <style>
        ...
        .dark .glass-panel {
            ...
            border: 1px solid rgba(56, 54, 99, 0.5);
        }
...
<body class="bg-gray-50 dark:bg-background-dark text-slate-800 dark:text-gray-200 h-screen flex overflow-hidden selection:bg-primary selection:text-white transition-colors duration-300">
     <aside class="w-72 bg-white dark:bg-[#131221] border-r border-gray-200 dark:border-border-dark hidden md:flex flex-col z-20 shadow-xl shadow-gray-200/50 dark:shadow-none">
        ...
        <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
            ...
            <a href="themes.php" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-primary/10 text-primary font-semibold transition-all">
                <span class="material-symbols-outlined">category</span>
                Thèmes
            </a>
    ...
    <main class="flex-1 flex flex-col min-w-0 overflow-hidden relative">
        <header class="h-20 bg-white/80 dark:bg-[#131221]/80 backdrop-blur-md border-b border-gray-200 dark:border-border-dark flex items-center justify-between px-8 z-10 sticky top-0">
            <h2 class="text-xl font-bold dark:text-white">Gestion des Thèmes</h2>

            <div class="flex items-center gap-4">
                <button onclick="document.getElementById('themeModal').classList.remove('hidden-modal')" class="bg-primary hover:bg-primary/90 text-white px-4 py-2 rounded-lg font-bold flex items-center gap-2 shadow-lg shadow-primary/20 transition-all">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <?php if (!empty($themes)): ?>
                    <?php foreach ($themes as $theme): ?>
                        <div class="glass-panel p-6 rounded-2xl group hover:border-primary/50 transition-all relative overflow-hidden">
                            ...
                            <div class="flex justify-between items-start mb-4 relative z-10">
                                ...
                                <div class="flex gap-2 opacity-75 group-hover:opacity-100 transition-opacity">
                            ...
                            <div class="flex items-center gap-2 text-xs font-medium text-slate-500 dark:text-slate-400 bg-gray-100 dark:bg-white/5 px-3 py-1.5 rounded-lg w-fit">
    ...
    <div id="themeModal" class="modal hidden-modal fixed inset-0 z-50 flex items-center justify-center px-4">
        ...
        <div class="modal-content relative bg-white dark:bg-[#1e1c30] w-full max-w-md rounded-2xl shadow-2xl border border-gray-200 dark:border-white/10 p-6 transform transition-transform scale-100">
            ...
            <form action="index.php" method="POST" class="space-y-4">
                ...
                <div>
                    <label class="block text-sm font-semibold text-slate-700 dark:text-gray-400 mb-1">Nom du Thème</label>
                    <input type="text" name="nom" required class="w-full bg-gray-50 dark:bg-[#121121] border-gray-200 dark:border-white/10 rounded-xl text-slate-900 dark:text-white focus:border-primary focus:ring-primary px-4 py-3" placeholder="Ex: Vintage">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-slate-700 dark:text-gray-400 mb-1">Description</label>
                    <textarea name="description" required class="w-full bg-gray-50 dark:bg-[#121121] border-gray-200 dark:border-white/10 rounded-xl text-slate-900 dark:text-white focus:border-primary focus:ring-primary px-4 py-3" rows="3" placeholder="Description courte..."></textarea>
                </div>
                <div>
                    <label class="block text-sm font-semibold text-slate-700 dark:text-gray-400 mb-1">Icône (Material Symbol)</label>
                    <div class="relative">
                        <input type="text" name="icone" class="w-full bg-gray-50 dark:bg-[#121121] border-gray-200 dark:border-white/10 rounded-xl text-slate-900 dark:text-white focus:border-primary focus:ring-primary pl-10 px-4 py-3" placeholder="Ex: directions_car">
                ...
                <div class="flex justify-end gap-3 mt-6 pt-4 border-t border-gray-100 dark:border-white/5">
    ...
    <div id="themeEditModal" class="modal hidden-modal fixed inset-0 z-50 flex items-center justify-center px-4">
        ...
        <div class="modal-content relative bg-white dark:bg-[#1e1c30] w-full max-w-md rounded-2xl shadow-2xl border border-gray-200 dark:border-white/10 p-6 transform transition-transform scale-100">
            ...
            <form action="index.php" method="POST" class="space-y-4">
                ...
                <div>
                    <label class="block text-sm font-semibold text-slate-700 dark:text-gray-400 mb-1">Nom du Thème</label>
                    <input type="text" name="nom" id="edit_nom" required class="w-full bg-gray-50 dark:bg-[#121121] border-gray-200 dark:border-white/10 rounded-xl text-slate-900 dark:text-white focus:border-primary focus:ring-primary px-4 py-3">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-slate-700 dark:text-gray-400 mb-1">Description</label>
                    <textarea name="description" id="edit_description" required class="w-full bg-gray-50 dark:bg-[#121121] border-gray-200 dark:border-white/10 rounded-xl text-slate-900 dark:text-white focus:border-primary focus:ring-primary px-4 py-3" rows="3"></textarea>
                </div>
                <div>
                    <label class="block text-sm font-semibold text-slate-700 dark:text-gray-400 mb-1">Icône (Material Symbol)</label>
                    <div class="relative">
                        <input type="text" name="icone" id="edit_icone" class="w-full bg-gray-50 dark:bg-[#121121] border-gray-200 dark:border-white/10 rounded-xl text-slate-900 dark:text-white focus:border-primary focus:ring-primary pl-10 px-4 py-3">
                        <span class="material-symbols-outlined absolute left-3 top-3 text-slate-400">mood</span>
                    </div>
                </div>
