 ...
 <body class="bg-gray-50 dark:bg-dark text-slate-800 dark:text-gray-200 antialiased h-screen flex overflow-hidden selection:bg-primary selection:text-white transition-colors duration-300">
     ...
     <div id="tagsModal" class="modal hidden-modal fixed inset-0 z-50 flex items-center justify-center px-4">
         ...
         <div class="modal-content relative bg-white dark:bg-[#1e1c30] w-full max-w-lg rounded-2xl shadow-2xl border border-gray-200 dark:border-white/10 p-6">
             ...
             <form action="index.php?action=addTags" method="POST">
                 <div class="space-y-4">
                     <p class="text-sm text-slate-500 dark:text-slate-400">
                         Séparez les tags par des virgules (ex: #Mercedes, #Luxe, #Vitesse)
                     </p>
                     <div>
                         <textarea name="tags" rows="5" required class="block w-full rounded-xl border-0 py-3 bg-gray-50 dark:bg-[#121121] text-slate-900 dark:text-white shadow-sm ring-1 ring-inset ring-gray-200 dark:ring-white/10 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6" placeholder="#Tag1, #Tag2..."></textarea>
                     </div>
                 </div>
     ...
     <div id="editTagModal" class="modal hidden-modal fixed inset-0 z-50 flex items-center justify-center px-4">
         ...
         <div class="modal-content relative bg-white dark:bg-[#1e1c30] w-full max-w-md rounded-2xl shadow-2xl border border-gray-200 dark:border-white/10 p-6">
             ...
             <div class="flex items-center justify-between mb-4">
                 ...
                 <button onclick="closeEditTagModal()" class="text-slate-400 hover:text-slate-600 dark:hover:text-white">
                     <span class="material-symbols-outlined">close</span>
                 </button>
             </div>

             <form action="index.php?action=updateTag" method="POST" class="space-y-4">
                 ...
                 <div>
                     ...
                     <div class="relative">
                         ...
                         <input type="text" name="nom" id="edit_tag_nom" required
                             class="w-full bg-gray-50 dark:bg-[#121121] border-gray-200 dark:border-white/10 rounded-xl text-slate-900 dark:text-white focus:border-primary focus:ring-primary pl-10 px-4 py-3"
                             placeholder="Ex: BMW">
                     </div>
                 </div>
